...
<body>
    ...
    <ul class="nav">
        ...
        <li class="nav-item"><a class="nav-link" href="array.php">Simple Arrays</a></li>
        ...
        <li class="nav-item"><a class="nav-link" href="functions.php">Simple User Defined Functions</a></li>
    </ul>